...
const NewLike = () => {
  ...
  function handleSubmit(event) {
    ...
    const url = 'https://celebrighter.com/v1/add-new-like.php';
    ...
    <div className="NewLike">
      ...
      {/* <form action="http://localhost/v1/add-new-post.php" method="post" enctype="multipart/form-data"> */}
        ...
        <div className="postOptions"> 
          <h2>Do you want to Give One Free Point? </h2><br />
          
        </div>
        <button className="button ps-button" type="submit">Confirm</button>
      </form>
      </div>
    </div>
  );
